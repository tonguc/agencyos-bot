    ...
    >
      <div className="p-4">
        ...
        <div className="mt-3 space-y-2 text-xs text-muted">
          ...
          <AdvancedScores
            competitionDensity={lead.competition_density_score}
            ppcWaste={lead.ppc_waste_score}
            socialMismatch={lead.social_mismatch_score}
        ...
        {selected && (
          <div className="mt-3 pt-3 border-t border-stroke space-y-3">
            ...
            {/* Advanced micro-scoring (expanded view) */}
            <AdvancedScores
              competitionDensity={lead.competition_density_score}
              ppcWaste={lead.ppc_waste_score}
              socialMismatch={lead.social_mismatch_score}
